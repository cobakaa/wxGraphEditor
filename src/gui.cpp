...
frmMain::frmMain( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	// Connect Events
	this->Connect( wxEVT_MOVE, wxMoveEventHandler( frmMain::Render ) );
	...
	m_panel6->Connect( wxEVT_SIZE, wxSizeEventHandler( frmMain::Render ), NULL, this );
...
{
	// Disconnect Events
	this->Disconnect( wxEVT_MOVE, wxMoveEventHandler( frmMain::Render ) );
	...
	m_panel6->Disconnect( wxEVT_SIZE, wxSizeEventHandler( frmMain::Render ), NULL, this );
